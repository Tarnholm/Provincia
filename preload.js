...
contextBridge.exposeInMainWorld("electronAPI", {
  ...
  factionTransferScan: (modDataDir, campaign) => ipcRenderer.invoke("faction-transfer-scan", modDataDir, campaign),
  factionTransferRoster: (modDataDir, faction, campaign) => ipcRenderer.invoke("faction-transfer-roster", modDataDir, faction, campaign),
  factionTransferApply: (modDataDir, faction, choice, campaign) => ipcRenderer.invoke("faction-transfer-apply", modDataDir, faction, choice, campaign),
  newFactionScan: (modDataDir, campaign) => ipcRenderer.invoke("new-faction-scan", modDataDir, campaign),
  newFactionDonor: (modDataDir, donor, campaign) => ipcRenderer.invoke("new-faction-donor", modDataDir, donor, campaign),
  newFactionApply: (modDataDir, choice) => ipcRenderer.invoke("new-faction-apply", modDataDir, choice),
  ...
  getTradeLanesDev: (modDataDir, portLevel) => ipcRenderer.invoke("get-trade-lanes-dev", modDataDir, portLevel),
