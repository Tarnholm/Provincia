...
describe("incomeModel — cracked constants", () => {
  ...
  test("cracked income constants (2026-06-10 session)", () => {
    ...
    expect(im.CALIB.tradeRouteK).toBeCloseTo(5.27, 2); // land law v2 (385-row 3-faction refit)
    expect(im.CALIB.tradeRoutePopX).toBeCloseTo(0.0064, 4); // resource-driven, pop ~irrelevant
