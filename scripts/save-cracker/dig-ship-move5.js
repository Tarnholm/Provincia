// dig-ship-move5.js — full aligned 2-pointer diff for ship-move (save_5.2 vs save_6.2)
...
while (pa < A.length && pb < B.length) {
  ...
  if (events.length % 5000 === 0 && events.length > 0) {
...
fs.writeFileSync(path.join(__dirname, 'out-ship-move-events.json'),
