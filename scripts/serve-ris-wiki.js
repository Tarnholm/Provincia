...
const NAV = [
  ["Start here", [["/README.md", "Wiki index"], ["/factions.md", "All factions"],
    ...
    ["/ancillaries.md", "Retinue"], ["/reforms.md", "Reforms"], ["/sizes.md", "Settlement sizes"]]],
...
function crumbs(rel) {
  ...
  if (segs.length > 1) {
    ...
    const INDEX_OF = {
      ...
      traits: "/traits.md", ancillaries: "/ancillaries.md", reforms: "/reforms.md",
    };
...
const server = http.createServer((req, res) => {
  ...
  if (rel === "/search") {
    ...
    const ORDER = ["overview", "factions", "regions", "settlements", "units", "buildings",
      "goods", "cultures", "religions", "traits", "ancillaries", "reforms", "sizes", "tags"];
